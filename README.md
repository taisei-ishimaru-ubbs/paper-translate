...
この checkout は [`taiseee/paper-translate`](https://github.com/taiseee/paper-translate) の研究室用 fork。
`origin` は fork、`upstream` は原本を参照する。`papers/` も履歴に含め、PDF と PNG は Git LFS で管理する。
